...
payment_date
from payment
where payment_date between '2005-05-27 0:00:00' and '2005-05-27 23:59:59';
...
payment_date,
amount
from payment where amount > 5 LIMIT 1000 offset 2000;
...
length,
rental_duration
from film where special_features LIKE '%Behind the Scenes%' and length < 120 and rental_duration between '5' and '7' order by length DESC limit 10;
...
LEFT JOIN city on staff.last_update = city.last_update;
